...
```{r fig.cap="A matrix",fig.align="center",fig.width=4, fig.height=4,out.extra="class=external"}
knitr::include_graphics('img/colormatrix.png')
```
...
<aside> 
```{r,fig.cap="The continuous function upper bounded 0-1 loss."}
...
This RKHS interpretation could lead to a stability bound for solutions of this optimization 
...
Formal proof can be found in [@agarwal2005stability].
...
__Thurstone__ model is similar to __BTL__ model
